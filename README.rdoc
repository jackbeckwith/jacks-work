...
I included one Heroku Add-on in my app called SendGrid. SendGrid enabled me to send emails to users of my app in two instances - when they either uploaded a new song or received a new follower. An email from "info@collabwithme.com" is sent to the email they used to register. Here's the documentation: https://devcenter.heroku.com/articles/sendgrid.
